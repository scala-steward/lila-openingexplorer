...
pub struct StableZobrist128(pub u128);

impl PartialEq for StableZobrist128 {
    #[inline]
    fn eq(&self, other: &StableZobrist128) -> bool {
        self.0 == other.0
    }
}

impl From<u128> for StableZobrist128 {
    #[inline]
    fn from(value: u128) -> StableZobrist128 {
        StableZobrist128(value)
    }
}
impl From<StableZobrist128> for u128 {
    #[inline]
    fn from(value: StableZobrist128) -> u128 {
        value.0
    }
}

impl BitXor for StableZobrist128 {
    type Output = StableZobrist128;
    #[inline]
    fn bitxor(self, other: StableZobrist128) -> StableZobrist128 {
        StableZobrist128(self.0 ^ other.0)
    }
}
impl BitXor<&StableZobrist128> for StableZobrist128 {
    type Output = StableZobrist128;
    #[inline]
    fn bitxor(self, other: &StableZobrist128) -> StableZobrist128 {
        StableZobrist128(self.0 ^ other.0)
...
impl BitXorAssign for StableZobrist128 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: StableZobrist128) {
        self.0 ^= rhs.0;
    }
}
impl BitXorAssign<&StableZobrist128> for StableZobrist128 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: &StableZobrist128) {
        self.0 ^= rhs.0;
    }
...
impl fmt::Debug for StableZobrist128 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "StableZobrist128({:#x})", self.0)
    }
}
impl fmt::UpperHex for StableZobrist128 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::UpperHex::fmt(&self.0, f)
    }
}
impl fmt::LowerHex for StableZobrist128 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::LowerHex::fmt(&self.0, f)
    }
}
impl fmt::Octal for StableZobrist128 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Octal::fmt(&self.0, f)
    }
}
impl fmt::Binary for StableZobrist128 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Binary::fmt(&self.0, f)
    }
}

impl ZobristValue for StableZobrist128 {
    #[inline]
    fn zobrist_for_piece(square: Square, piece: Piece) -> StableZobrist128 {
        let piece_idx = (usize::from(piece.role) - 1) * 2 + piece.color as usize;
        StableZobrist128(PIECE_MASKS[64 * piece_idx + usize::from(square)])
    }

    #[inline]
    fn zobrist_for_white_turn() -> StableZobrist128 {
        StableZobrist128(WHITE_TURN_MASK)
    }

    #[inline]
    fn zobrist_for_castling_right(color: Color, side: CastlingSide) -> StableZobrist128 {
        StableZobrist128(
    ...
    #[inline]
    fn zobrist_for_en_passant_file(file: File) -> StableZobrist128 {
        StableZobrist128(EN_PASSANT_FILE_MASKS[usize::from(file)])
    }

    #[inline]
    fn zobrist_for_remaining_checks(color: Color, remaining: RemainingChecks) -> StableZobrist128 {
        if remaining < RemainingChecks::default() {
            StableZobrist128(REMAINING_CHECKS_MASKS[usize::from(remaining) + color.fold_wb(0, 3)])
        } else {
            <StableZobrist128>::default()
        }
    }

    #[inline]
    fn zobrist_for_promoted(square: Square) -> StableZobrist128 {
        StableZobrist128(PROMOTED_MASKS[usize::from(square)])
    }

    #[inline]
    fn zobrist_for_pocket(color: Color, role: Role, pieces: u8) -> StableZobrist128 {
        if 0 < pieces && pieces <= 16 {
            let color_idx = color as usize;
            let role_idx = usize::from(role) - 1;
            let pieces_idx = usize::from(pieces) - 1;
            StableZobrist128(POCKET_MASKS[color_idx * 6 * 16 + role_idx * 16 + pieces_idx])
        } else {
            <StableZobrist128>::default()
        }
    }
...
impl nohash_hasher::IsEnabled for StableZobrist128 {}

impl Hash for StableZobrist128 {
